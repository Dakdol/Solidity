...
contract UintandString {
    ...
    function setAandB(uint _a, string memory _b) public {
        a = _a;
        b = _b;
    }

    function getAandB() public view returns(uint , string memory ){
        return (a,b);
    }

}
//a와 b에 내가 원하는 값을 넣을 수 있는 함수 그리고 a와 b의 값을 반환하는 함수를 각각 따로 만드세요.